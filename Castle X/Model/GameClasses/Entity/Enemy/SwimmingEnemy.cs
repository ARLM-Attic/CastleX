...
namespace CastleX
{
    ...
    /// </summary>
    public sealed class SwimmingEnemy : Enemy
    {
        ...
        /// </summary>
        public SwimmingEnemy(ScreenManager thisScreenManager, Level level, Vector2 position, EnemyType type, int enemyNumber, int contactDamage)
        {
            this.level = level;
            Type = type;
        ...
        {
            //runAnimation = new Animation(Level.screenManager.SwimmingRunTexture[enemyNumber - 1], 0.1f, true, level.screenManager.SkinSettings.FrameWidth_Swimming_Run[enemyNumber - 1]);
            idleAnimation = new Animation(Level.screenManager.SwimmingIdleTexture[enemyNumber - 1], 0.15f, true, level.screenManager.SkinSettings.FrameWidth_Swimming_Idle[enemyNumber - 1]);
            //dieAnimation = new Animation(Level.screenManager.SwimmingDieTexture[enemyNumber - 1], 0.07f, false, level.screenManager.SkinSettings.FrameWidth_Swimming_Die[enemyNumber - 1]);

            sprite.PlayAnimation(idleAnimation);

            // Load sounds.
            //swimmingEnemyKilledSound = Level.screenManager.SwimmingEnemyKilledSound;
