...
namespace CastleX
{
    ...
    /// </summary>
    public sealed class MonsterEnemy : Enemy
    {
        ...
        /// </summary>
        public MonsterEnemy(ScreenManager thisScreenManager, Level level, Vector2 position, EnemyType type, int enemyNumber, int contactDamage)
        {
            this.level = level;
            Type = type;
